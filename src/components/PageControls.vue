<template>
  <div class="row mt-2">
    <div class="col-3 form-group">
      <select name id class="form-control" @change="changePageSize">
    ...
    <div class="text-right col">
      ...
      <span v-if="currentPage > 4">
        <button @click="setCurrentPage(1)" class="btn btn-secondary mx-1">1</button>
        <span class="h4">...</span>
      </span>
      <span class="mx-1">
        <button
      ...
      <span v-if="currentPage <= pageCount - 4">
        <span class="h4">...</span>
        <button @click="setCurrentPage(pageCount)" class="btn btn-secondary mx-1">{{pageCount}}</button>
      </span>
      <button
